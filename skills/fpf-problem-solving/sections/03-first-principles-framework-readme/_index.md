...
- [Practical-Use Cards](03-practical-use-cards.md) (204 lines) — Start with the current project question, not an ordinal route through FPF. The sixteen semantic keys below are stable navigation identifiers, not steps, kinds, relations, records, or result names....
...
- [How to Use This Repository](08-how-to-use-this-repository.md) (35 lines) — Start with the practical-use card that recognizes the current project question. If several fit, compare their situations, first-result differences, and stop or return conditions before inspecting the...
- [Citation](09-citation.md) (9 lines) — If you use FPF, please cite:
