...
| :--- | :--- | :--- |
| Self-evolution bias | The subject is said to observe, refine, or deploy itself, so the performing System and its Work disappear. | Name the changed subject and distinct acting side. Ordinary actor wording can remain short. When one particular dated `U.Work` is identified, keep its complete A.15.1/F.6 basis recoverable; an unused assignment identifier may stay out of the displayed sentence. The acting side may be external, or it may be an exact distinct subsystem or part established through the `A.12` reflexive split. |
