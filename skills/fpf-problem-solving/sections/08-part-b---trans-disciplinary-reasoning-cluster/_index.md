...
- [B.2.P - Emergence and MHT Precision Restoration](11-b-2-p---emergence-and-mht-precision-restoration.md) (257 lines) — Type: Part B precision-restoration pattern
- [B.2.2 - Meta-System Transition - System Specialization of MHT](12-b-2-2---meta-system-transition---system-specialization-of-mh.md) (225 lines) — Type: Part B holonic construction pattern
- [B.2.3 - Meta-Holon Transition With Episteme Result](13-b-2-3---meta-holon-transition-with-episteme-result.md) (208 lines) — Type: Part B holonic construction pattern
- [B.2.4 - Capability and Functioning Whole Reidentification](14-b-2-4---capability-and-functioning-whole-reidentification.md) (198 lines) — Type: Part B holonic construction pattern
- [B.2.5 - Supervisor-Subholon Feedback Relation](15-b-2-5---supervisor-subholon-feedback-relation.md) (218 lines) — Type: Part B holonic construction pattern
- [B.3 - Trust and Assurance Calculus](16-b-3---trust-and-assurance-calculus.md) (321 lines) — Type: Foundational (B)
- [B.3.3 — Assurance Subtypes & Levels](17-b-3-3-assurance-subtypes-levels.md) (104 lines) — Use this when. A team must decide whether the available support is enough for a particular claim and receiving use, or what a published assurance level permits a recipient to conclude. Start with...
- [B.3.4 - Evidence Decay & Epistemic Debt](18-b-3-4---evidence-decay-epistemic-debt.md) (128 lines) — Use this when. An earlier result is being relied on now, and a changed condition or a due review may change whether it still supports the receiving claim. Begin with the relied-on use and the premise...
