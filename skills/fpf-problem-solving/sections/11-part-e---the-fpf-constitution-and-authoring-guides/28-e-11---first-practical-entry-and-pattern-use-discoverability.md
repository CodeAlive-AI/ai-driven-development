...
| `E11-3` | One publication job | README owns the sixteen public entries; Preface explains cross-cutting ideas; ToC and retrieval locate; local `Problem frame` sections recognize; expanded cases disambiguate. None maintains a competing canon. |
...
| `E11-10` | Thin projection and direct authority | ToC, query phrases, cards, and retrieval are finding aids. A substantive claim returns to the direct pattern whose content defines, constrains, or tests it. |
