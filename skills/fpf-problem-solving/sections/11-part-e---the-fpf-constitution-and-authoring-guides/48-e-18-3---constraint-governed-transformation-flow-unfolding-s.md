...
| **Evidence path as evidence** | A path through evidence-looking boxes or a `subjectUse=evidence` label is treated as sufficient evidence. | Use the applicable `A.10`, `B.3` or `G.6` evidence or assurance rule and cite the exact claim or relation that passes it. |
