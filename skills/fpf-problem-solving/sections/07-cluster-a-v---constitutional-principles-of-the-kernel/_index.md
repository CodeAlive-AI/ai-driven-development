...
- [A.16.2 - Reopen / SketchBackoff / Respecify](22-a-16-2---reopen-sketchbackoff-respecify.md) (225 lines) — Type: Architectural (A)
- [A.17 - Canonical “Characteristic” (A.CHR‑NORM)](23-a-17---canonical-characteristic.md) (136 lines) — To have reproducibility and explainability there is a need to measure various aspects of systems or knowledge epistemes or publications. A dedicated measurement backbone (see C.MM‑CHR, Measurement &...
- [A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)](24-a-18---minimal-cslc-in-kernel.md) (152 lines) — Aliases (for narrative use only): _“Axis”_ (≈ Characteristic), _“Point”_ (≈ Coordinate). _(These colloquial aliases may be used in Plain language explanations, but never in formal identifiers or...
- [A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)](25-a-19---characteristicspace-dynamics-hook.md) (443 lines) — Type: Kernel characteristic-space and dynamics-typing pattern
- [A.19.ECS - Evaluation CharacteristicSpace Construction](26-a-19-ecs---evaluation-characteristicspace-construction.md) (252 lines) — Normativity: Normative
- [A.19.SPR - State-Family Precision Restoration](27-a-19-spr---state-family-precision-restoration.md) (208 lines) — Type: State-family precision-restoration pattern
- [A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search/Outcome-Space Substrate](28-a-19-source-set-space-substrate---source-set-and-search-outc.md) (537 lines) — Type: Architectural (A)
- [A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View](29-a-19-declared-substrate-interpretive-view---declared-substra.md) (495 lines) — Type: Architectural (A)
- [A.19.CN - CN‑frame (comparability & normalization)](30-a-19-cn---cn-frame.md) (378 lines) — Scope. This CN‑frame Algebra & Normalization Discipline extends A.19 by fixing the governance Standard for CN‑frames, defining a conformance checklist and regression harness, and providing didactic...
- [A.19.CHR - CHRMechanismSuite](31-a-19-chr---chrmechanismsuite.md) (683 lines) — Type: Architectural (A)
- [A.19.UNM - Unified Normalization Mechanism (UNM)](32-a-19-unm---unified-normalization-mechanism.md) (422 lines) — Type: Architectural (A)
- [A.19.UINDM - Unified Indicatorization Mechanism (UINDM)](33-a-19-uindm---unified-indicatorization-mechanism.md) (289 lines) — Type: Architectural (A)
- [A.19.USCM - Unified Scoring Mechanism, USCM](34-a-19-uscm---unified-scoring-mechanism-uscm.md) (328 lines) — Type: Architectural (A)
- [A.19.ULSAM - Unified Lawful Scale Aggregation Mechanism (ULSAM)](35-a-19-ulsam---unified-lawful-scale-aggregation-mechanism.md) (295 lines) — Type: Architectural (A)
- [A.19.CPM - Unified Comparison Mechanism (CPM)](36-a-19-cpm---unified-comparison-mechanism.md) (335 lines) — Type: Architectural (A)
