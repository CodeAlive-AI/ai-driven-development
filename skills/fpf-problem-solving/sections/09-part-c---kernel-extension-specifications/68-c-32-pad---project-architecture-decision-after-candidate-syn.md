...
| `projectSystemOfInterestRef?`, `intendedProjectSystemClaimRef?`, or `systemOfInterestRoleAssignmentRef?` | Use A.15.6 for actual-versus-intended designation and the compound-selection stop, and A.2/A.2.1 for the named role/taxonomy interpretation and obtaining assignment. Keep every independently obtaining Work/change/use fact; remove any reference the decision alone was being used to prove. |
