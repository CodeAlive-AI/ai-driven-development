...
- [C.2.1 - U.Episteme: Constitution, Empirical Grounding, and Edition Relations](02-c-2-1---u-episteme-constitution-empirical-grounding-and-edit.md) (547 lines) — Normativity: Normative except where a section is explicitly marked informative
...
- [C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace](05-c-2-2a---u-languagestatespace---language-state-chart-over-u.md) (263 lines) — Type: Architectural (A)
...
- [C.3.1 - U.Kind and U.SubkindOf Core](14-c-3-1---u-kind-and-u-subkindof-core.md) (151 lines) — Type: Typed reasoning core pattern
- [C.3.2 - Kind Intent, Membership Judgment, and Extension](15-c-3-2---kind-intent-membership-judgment-and-extension.md) (229 lines) — Type: Local kind declaration and classification pattern
- [C.3.3 - KindBridge and CL^k — Cross-local Correspondence between Distinct Kinds](16-c-3-3---kindbridge-and-cl-k-cross-local-correspondence-betwe.md) (194 lines) — One-line summary. A changed practice, source, team, or scheme first triggers a comparison of kind definitions. If the same kind continues, reuse it and evaluate the receiving candidate afresh; no...
- [C.3.4 - KindUseAdaptationDeclaration — Contextual Adaptation of Kinds without Cloning](17-c-3-4---kinduseadaptationdeclaration-contextual-adaptation-o.md) (217 lines) — One-line summary. A KindUseAdaptationDeclaration is a C.2.1 declaration episteme for one named local use of an exact base kind. It pins the base KindSignature edition, candidate-feature constraints,...
...
- [C.21 - Field Health & Structure (Discipline-CHR)](32-c-21---field-health-structure.md) (256 lines) — Purpose. Give FPF a typed, reviewable way to characterize the health, maturity, and structure of a scientific or engineering discipline, without collapsing into taste, anecdotes, dashboard views,...
- [C.22 - Task Typing and TaskSignature Assignment (Problem-CHR)](33-c-22---task-typing-and-tasksignature-assignment.md) (380 lines) — Purpose. Give FPF an admissible, minimal, and portable TaskSignature declaration for selector-facing use after the problem-side episteme is stable enough for Principles-to-Work, eligibility,...
...
- [C.22.2 - ProblemCard](36-c-22-2---problemcard.md) (649 lines) — Normativity: Normative
...
- [C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)](38-c-24---agentic-tool-use-and-call-planning.md) (379 lines) — Normativity: Normative
...
- [C.26 - Quantum-Like Modeling Lens](40-c-26---quantum-like-modeling-lens.md) (616 lines) — Type: Architectural pattern
...
- [C.27 - Temporal Claim Adequacy: State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change](44-c-27---temporal-claim-adequacy-state-readings-temporal-trend.md) (1970 lines) — Type: Claim-adequacy pattern
...
- [C.28 - CausalUse-CAL: Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability](46-c-28---causaluse-cal-causal-use-questions-causality-ladder-r.md) (885 lines) — Normativity: Normative unless explicitly marked informative
- [C.29 - Mathematical Lens Use](47-c-29---mathematical-lens-use.md) (1364 lines) — Type: Architectural pattern
- [C.30 - Grounded Architecture and Selected-Structure Adequacy](48-c-30---grounded-architecture-and-selected-structure-adequacy.md) (682 lines) — Type: Architectural pattern
- [C.30.AD - Architecture Description Adequacy](49-c-30-ad---architecture-description-adequacy.md) (465 lines) — Type: Architectural pattern
...
- [C.30.ASV - Architecture Structural View Adequacy (ASV)](53-c-30-asv---architecture-structural-view-adequacy.md) (804 lines) — Type: Architectural pattern
- [C.30.LCA - Control Structure View Adequacy (LCA)](54-c-30-lca---control-structure-view-adequacy.md) (314 lines) — Type: Architectural subpattern under C.30
...
- [C.32.CONWAY - Architecture-Influence and Transformed-Architecture Correspondence](65-c-32-conway---architecture-influence-and-transformed-archite.md) (418 lines) — Type: Architectural subpattern under C.32
...
- [C.35 - Structural Synthesis and Discovery Adequacy](73-c-35---structural-synthesis-and-discovery-adequacy.md) (208 lines) — Type: Architectural pattern
- [C.36 - Cultural Evolution and Cultural-Evolution Engineering](74-c-36---cultural-evolution-and-cultural-evolution-engineering.md) (330 lines) — Tech-name: CulturalEvolutionEngineering
