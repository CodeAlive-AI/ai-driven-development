...
- [C.3.4 - RoleMask — Contextual Adaptation of Kinds (without cloning)](17-c-3-4---rolemask-contextual-adaptation-of-kinds.md) (195 lines) — One-line summary. Defines RoleMask as a C.2.1 declaration episteme for one named local use of an exact base kind. Its content pins the base KindSignature edition, additional candidate-feature...
...
- [C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)](38-c-24---agentic-tool-use-and-call-planning.md) (371 lines) — Normativity: Normative
...
- [C.26 - Quantum-Like Modeling Lens](40-c-26---quantum-like-modeling-lens.md) (612 lines) — Type: Architectural pattern
...
- [C.30 - Grounded Architecture and Selected-Structure Adequacy](48-c-30---grounded-architecture-and-selected-structure-adequacy.md) (681 lines) — Type: Architectural pattern
...
- [C.32 - Architecture Candidate Synthesis](60-c-32---architecture-candidate-synthesis.md) (329 lines) — Type: Architectural pattern
- [C.32.P2S - Problem-to-Structure Architecturing Unfolding](61-c-32-p2s---problem-to-structure-architecturing-unfolding.md) (344 lines) — Type: Architectural process pattern under C.32
...
- [C.32.CONWAY - Architecture-Influence and Transformed-Architecture Correspondence](65-c-32-conway---architecture-influence-and-transformed-archite.md) (414 lines) — Type: Architectural subpattern under C.32
- [C.32.MLAO - Multilevel Architecture Residual Optimization](66-c-32-mlao---multilevel-architecture-residual-optimization.md) (273 lines) — Type: Architectural subpattern under C.32
- [C.32.FAIL - Architecture Failure Recognition and Repair](67-c-32-fail---architecture-failure-recognition-and-repair.md) (240 lines) — Type: Architectural subpattern under C.32
- [C.32.PAD - Project Architecture Decision After Candidate Synthesis](68-c-32-pad---project-architecture-decision-after-candidate-syn.md) (329 lines) — Type: Architecture decision pattern under C.32
...
- [C.32.ADA - Architecture Decision Adequacy Scales](70-c-32-ada---architecture-decision-adequacy-scales.md) (294 lines) — Type: Architecture evaluation pattern under C.32
