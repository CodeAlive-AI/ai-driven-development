...
- [C.11 - Decision Theory (Decsn-CAL)](20-c-11---decision-theory.md) (706 lines) — Normativity: Normative unless marked informative
...
- [C.19 - Explore-Exploit Live-Pool Governor](28-c-19---explore-exploit-live-pool-governor.md) (374 lines) — Normativity: Normative
- [C.19.1 - Bitter‑Lesson Preference (BLP)](29-c-19-1---bitter-lesson-preference.md) (156 lines) — One-screen purpose (manager-first).
- [C.19.2 - Use-Bounded Apparatus Application](30-c-19-2---use-bounded-apparatus-application.md) (168 lines) — Type: Architectural (A)
...
- [C.21 - Field Health & Structure (Discipline-CHR)](32-c-21---field-health-structure.md) (265 lines) — Purpose. Give FPF a typed, reviewable way to characterize the health, maturity, and structure of a scientific or engineering discipline without collapsing the result into taste, anecdotes, a...
...
- [C.22.2 - ProblemCard](36-c-22-2---problemcard.md) (658 lines) — Normativity: Normative
...
- [C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)](38-c-24---agentic-tool-use-and-call-planning.md) (334 lines) — Normativity: Normative
- [C.25 - Q-Bundle: Authoring "-ilities" as Structured Quality Bundles](39-c-25---q-bundle-authoring--ilities-as-structured-quality-bun.md) (418 lines) — Type: Definitional (D)
...
- [C.26.3 - Viability-Envelope Boundary Regulation](43-c-26-3---viability-envelope-boundary-regulation.md) (335 lines) — Type: Architectural pattern
