...
| Built-asset maintenance program where digital-twin abstraction hides lower-scope source loss | Asset-family scope against maintenance-work scope; reference-designation, information, and work-method structures | Add source-return scope; split information view; retarget maintenance responsibility | Stop before built-asset architecture-description, publication-face, or A.10 evidence-relation claims unless their subject patterns are current. |
