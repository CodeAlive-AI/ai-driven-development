...
| 07 | [A.V — Principles](sections/07-cluster-a-v---constitutional-principles-of-the-kernel/_index.md) | 41 | **Prevent confusion and reconcile premises**: category errors, ontology premises, production-work identity and completion, measuring, comparing, evidence graphs, mechanism suites, flow constraints, gate profiles, constraint-governed unfolding. |
