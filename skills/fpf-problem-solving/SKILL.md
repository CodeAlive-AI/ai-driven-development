...
| 03 | [FPF Readme](sections/03-first-principles-framework-readme/_index.md) | 8 | **Onboard**: understand what each part contributes and when several transformation flows form one network. |
...
| 06 | [A.IV.A — Signatures](sections/06-cluster-a-iv-a---signature-stack-boundary-discipline/_index.md) | 28 | **Set boundaries, derive relations, and render**: distinguish relations from occurrences; recover exact method/work relations; derive needed relation claims; classify statements as definitions, gates, duties, evidence, signatures, semantic repairs, or faithful structure-to-narrative transformations. |
