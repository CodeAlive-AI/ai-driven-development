...
| 11 | [Part E — Constitution and Authoring](sections/11-part-e---the-fpf-constitution-and-authoring-guides/_index.md) | 58 | **Enter, apply, govern, and publish**: first-practical entry and pattern discoverability, first-useful-result pattern application, framework forms and carriers, lexical discipline, multi-view publication, transformation-flow structures and networks, pattern quality, ontic/U-kind governance. |
