...
description: "Use First Principles Framework (FPF) to think through hard problems, architect systems, evaluate alternatives, decompose complexity, classify problems or kinds, define quality, apply a pattern, decide under uncertainty, establish causality, reason about time and trends, synthesize architecture, check model fit, recover project/process/case/system/role subjects, trace outside-use dependencies, distinguish relations or occurrences, govern ontic/U-kind admission, synthesize source ontologies, assemble framework publication forms, develop capability for named work, publish multi-view artifacts, refresh SoTA packs, or trace provenance. Also triggers on: FPF, bounded contexts, SoTA packs, assurance calculus, decision theory, causal/temporal reasoning, architecture, modularity, transformation-flow networks, narrative rendering, structural adequacy, cultural evolution, quality gates, lexical discipline, FPF Parts A-I. Not for simple task planning, general philosophy, or Agile unrelated to FPF."
---
...
| 03 | [FPF Readme](sections/03-first-principles-framework-readme/_index.md) | 10 | **Enter, onboard, and recover**: choose a practical entry, understand what each part contributes, connect transformation flows, or recover a lost path from outside use to recursive builders. |
...
| 09 | [Part C — Extensions](sections/09-part-c---kernel-extension-specifications/_index.md) | 76 | **Score, search, and architect**: epistemic quality, typed reasoning, measurement, decisions, bounded apparatus use, temporal/causal/math lenses, architecture synthesis across non-isomorphic practice structures, structural adequacy, cultural evolution. |
