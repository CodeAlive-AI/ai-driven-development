...
| **Transform, document, and reuse epistemes or views** while preserving or explicitly changing their subject, render structure into narrative, reuse exact viewpoint references or author a project-local viewpoint family, or stabilize a publication unit | 06 A.IV.A → A.6.2 Effect-Free Episteme Morphing, A.6.3 Episteme Viewing, A.6.4 EntityOfConcern Retargeting, A.6.3.NAR Structure-to-Narrative Rendering; 11 Part E → E.17.1 Viewpoint Bundle Library, E.17.2 project-local TEVB template, E.17 Multi-View Publication Kit, E.17.EFP Explanation Faithfulness, E.17.AUD PublicationUnit Stability |
...
| 07 | [A.V — Principles](sections/07-cluster-a-v---constitutional-principles-of-the-kernel/_index.md) | 42 | **Prevent confusion and recover direct subjects**: category errors, ontology premises, project/process/case language, production-work identity and completion, measuring, comparing, evidence graphs, mechanism suites, transformation-step constraint validity, independent-check gate decisions, constraint-governed unfolding. |
...
| 11 | [Part E — Constitution and Authoring](sections/11-part-e---the-fpf-constitution-and-authoring-guides/_index.md) | 59 | **Enter, apply, evolve, govern, reuse, and publish**: first-practical entry and pattern discoverability, first-useful-result pattern application, framework forms and carriers, role-meaning recovery, pattern-change edition continuity and impact analysis, reusable viewpoint-reference bundles and project-local viewpoint-family templates, multi-view publication, transformation-flow structures and networks, pattern quality, ontic/U-kind governance. |
