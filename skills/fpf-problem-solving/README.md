...
Clone the official upstream `ailev/FPF` into the temporary `FPF/` input directory, then re-run the splitter to rebuild the `sections/` hierarchy. Remove the temporary clone after regeneration:
